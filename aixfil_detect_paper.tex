...
\begin{figure}[!htbp]
  \centerline{\includegraphics[width=0.9\columnwidth]{figures/fig6_dpapi_impact}}
...
\begin{figure}[!htbp]
  \centerline{\includegraphics[width=0.9\columnwidth]{figures/fig4_timeline_heatmap}}
...
\begin{figure}[!htbp]
  \centerline{\includegraphics[width=0.9\columnwidth]{figures/fig5_minhash_scatter}}
...
\begin{figure}[!htbp]
  \centerline{\includegraphics[width=0.9\columnwidth]{figures/fig1_wacs_distribution}}
...
\begin{figure}[!htbp]
  \centerline{\includegraphics[width=0.9\columnwidth]{figures/fig3_source_contribution}}
...
\begin{figure}[!htbp]
  \centerline{\includegraphics[width=0.9\columnwidth]{figures/fig8_source_completeness}}
...
\begin{figure}[!htbp]
  \centerline{\includegraphics[width=0.9\columnwidth]{figures/fig7_window_sensitivity}}
...
\begin{figure}[!htbp]
  \centerline{\includegraphics[width=0.9\columnwidth]{figures/fig2_precision_recall_curve}}
